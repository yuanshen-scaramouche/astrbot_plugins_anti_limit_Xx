...
### Naming Conventions
- **Classes**: CapWords (PascalCase) - `DataProcessor`, `AntiRepeatPlugin`
...
- Log exceptions using `logging` module (not `print`) in production
